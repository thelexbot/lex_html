  ...
  return (
    ...
    >
      <FeatureSection
        ...
        description={`Search law the way you think, not the way databases expect.
Paraplex understands meaning, context, and intent — allowing you to ask layered, evolving questions instead of breaking your research flow.
Start with a broad constitutional issue, narrow it to a specific doctrine, challenge assumptions, or ask follow-ups — all within the same research thread.`}
        mediaType="youtube"
...
Get structured summaries, understand judicial reasoning, trace how principles are applied — and ask questions directly against the judgment itself.
Judgments stop being documents.
They become conversations.`}
      ...
      <FeatureSection
        ...
        description={`Bookmark exactly what matters — a paragraph, a line of reasoning, a dissent, or a procedural insight.
Your bookmarks evolve into a structured research trail you can return to anytime.
No more re-searching the same judgment.
No more lost arguments.`}
        mediaType="youtube"
        mediaSrc="https://www.youtube.com/embed/dQw4w9WgXcQ"
      />
...
Your inputs help surface better reasoning, sharper analysis, and clearer research paths.
