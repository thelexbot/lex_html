...
export default function ImageScroller({
  ...
  return (
    <section className="relative w-full overflow-hidden py-8 md:py-16 px-4 bg-background min-h-130 md:min-h-160">
      <div className="relative h-100 flex items-center overflow-visible mt-10 md:mt-36">
        <motion.div
            ...
            return (
              ...
              >
                <Image
                  ...
                  width={220}
                  height={300}
                  className="h-75 w-55 rounded-md object-cover shadow-2xl"
                  draggable={false}
